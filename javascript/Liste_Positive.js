...
function Ajouter(){
    ...
    if(nom_comercial.value !== "" && matiere_active.value !== "" && dose.value !== "" && dose_par.value !== "" && cible.value !== "" && dar.value !== "" && reentree.value !== "" && nbr_application.value !== "" && date_expiration.value !== "" && categorie.value !== ""){
...
function Modify(){
    if(nom_comercial_modifide.value !== "" && date_expiration_modifide.value !== ""  &&  matiere_active_modifide.value !== "" && dose_modifide.value !== "" && dose_par_modifide.value !== "" && cible_modifide.value !== "" && dar_modifide.value !== "" && reentree_modifide.value !== "" && nbr_application_modifide.value !== "" && categorie_modifide.value !== ""){
