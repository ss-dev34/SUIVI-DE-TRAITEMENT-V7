...
function Ajouter(){
    ...
    if(date.value !== "" && heure_debut.value !== "" && heure_fin.value !== "" && parcelle.value !== ""   && produit_commercial.value !== "" && bouilliee.value !== "" && materiel.value !== "" && methode.value !== "" && operateurs.value !== ""   && n_order.value !==""){
        //
        if(condtiion_clima_vent.value == "" && condtiion_clima_TC.value == "" && condtiion_clima_pluie.value == "" && condtiion_clima_nuages.value == ""){
            condtiion_clima_vent.value="-";
            condtiion_clima_TC.value="-";
            condtiion_clima_pluie.value="-";
            condtiion_clima_nuages.value="-";
...
function Modify(){
    ...
    */
    ...
    if(date_modifide.value !== "" && heure_debut_modifide.value !== "" && heure_fin_modifide.value !== "" && parcelle_modifide.value !== ""    && produit_commercial_modifide.value !== "" && bouilliee_modifide.value !== "" && materiel_modifide.value !== "" && methode_modifide.value !== "" && operateurs_modifide.value !== "" ){
        ...
        if(condtiion_clima_vent_modifide.value == "" && condtiion_clima_TC_modifide.value == "" && condtiion_clima_pluie_modifide.value == "" && condtiion_clima_nuages_modifide.value == ""){
            condtiion_clima_vent_modifide.value="-";
            condtiion_clima_TC_modifide.value="-";
            condtiion_clima_pluie_modifide.value="-";
            condtiion_clima_nuages_modifide.value="-";
